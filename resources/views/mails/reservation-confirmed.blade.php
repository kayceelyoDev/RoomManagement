                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.025); width: 100%; max-width: 600px;">
                    ...
                    <tr>
                        <td style="padding: 40px 40px;">
                            ...
                            <h2 style="margin: 0 0 20px; color: #1F2937; font-size: 22px; font-weight: bold; text-align: center;">Verify Your Reservation</h2>
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6; color: #4B5563; text-align: center;">
                                ...
                                We've received your booking request. To secure your stay at our sanctuary, please verify your details below.
                            </p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p style="margin: 0; color: #92400E; font-size: 13px; line-height: 1.5;">
                                                        <strong>Action Required:</strong> This link expires in <strong>2 hours</strong>. Unverified reservations will be automatically released.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid #E5E7EB; padding-bottom: 15px; margin-bottom: 15px;">
                                            <tr>
                                                <td style="font-size: 12px; font-weight: bold; text-transform: uppercase; color: #9CA3AF; letter-spacing: 1px;">Booking Summary</td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 10px;">
                                            <tr>
                                                ...
                                                <td style="text-align: right; color: #111827; font-weight: 600; font-size: 14px; padding-bottom: 8px;">
                                                    {{ \Carbon\Carbon::parse($reservation->check_in_date)->format('M j, Y') }}
                                                    <span style="color: #9CA3AF; font-weight: normal; font-size: 12px;">{{ \Carbon\Carbon::parse($reservation->check_in_date)->format('g:i A') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: right; color: #111827; font-weight: 600; font-size: 14px; padding-bottom: 8px;">
                                                    ...
                                                    <span style="color: #9CA3AF; font-weight: normal; font-size: 12px;">{{ \Carbon\Carbon::parse($reservation->check_out_date)->format('g:i A') }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="color: #6B7280; font-size: 14px; vertical-align: top; padding-bottom: 15px;">Contact</td>
                                                <td style="text-align: right; color: #111827; font-weight: 600; font-size: 14px; padding-bottom: 15px;">{{ $reservation->contact_number }}</td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 1px dashed #E5E7EB; padding-top: 15px;">
                                            <tr>
                                                ...
                                                <td style="text-align: right; color: #059669; font-size: 18px; font-weight: bold;">₱{{ number_format($reservation->reservation_amount, 2) }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="font-size: 12px; line-height: 1.5; color: #9CA3AF; text-align: center; margin-top: 20px;">
                                If you did not make this reservation, please ignore this email. No charges will be incurred.
                            </p>
